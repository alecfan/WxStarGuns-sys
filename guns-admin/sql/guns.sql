...
DROP DATABASE IF EXISTS wxstar_flowable;
CREATE DATABASE IF NOT EXISTS wxstar_flowable DEFAULT CHARSET utf8 COLLATE utf8_general_ci;

DROP DATABASE IF EXISTS wxstar;
CREATE DATABASE IF NOT EXISTS wxstar DEFAULT CHARSET utf8 COLLATE utf8_general_ci;
